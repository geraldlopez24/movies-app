...
CREATE TABLE movies.movie_languages (
  ...
  CONSTRAINT fk_ml_language FOREIGN KEY (language_id) REFERENCES movies.language (language_id),
  CONSTRAINT fk_ml_language_role FOREIGN KEY (language_role_id) REFERENCES movies.language_role (role_id)
);